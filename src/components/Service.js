...
const Service = ({item,onPress}) => {
  return (
    ...
    <View>
    <Icon name='file-document' color={"#004890"} size={25} style = {{
        // marginVertical:5,
        alignSelf:"center"
    }}/>
    ...
    <Text style = {{color:"#222222",marginHorizontal:10,marginVertical:2}} onPress={onPress}>View Details</Text>
    <Text style = {{color:item.status === "Incomplete" ? "red" :   "#222222",marginHorizontal:10,marginVertical:2}}>{item.status}</Text>
