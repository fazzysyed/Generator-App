...
const SpringFallSerivce5 = ({navigation}) => {
...
const getImage = ()=>{
  ...
  <Layout>
    <View style = {{justifyContent:"space-between",flex:1}}>
      <View>
      <Text style = {{color:"#222222",fontWeight:"bold",marginVertical:10,alignSelf:"center",marginHorizontal:30,textAlign:"center"}}>Image of Outside of generator</Text>
    {!image ?
...
<Image source={{uri:image}} style = {{height:"100%",width:"100%"}}/>
      ...
      <View style = {{marginVertical:200}}>
        <Button title={"Next"} width={160} onPress = {()=>{
          navigation.navigate("SpringFallSerivce6")
        }}/>
      </View>
    </View>
