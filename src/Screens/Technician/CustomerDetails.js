      ...
      if (item) {
        ...
        axios(config)
          .then(function (response) {
            ...
            setGenerators(response.data.generators, 'FarazAlishahahah');
      ...
      <View
        ...
        <View>
          <View
            ...
            <View>
              <Text
                style={{color: '#222222', width: 150, marginHorizontal: 10}}>
                {item.address ? item.address : 'not updated yet.'}
              </Text>
              <Text
                style={{color: '#222222', width: 150, marginHorizontal: 10}}>
                {item.city ? item.city : 'city not updated yet.'}
              </Text>
              <Text
                style={{color: '#222222', width: 150, marginHorizontal: 10}}>
                {item.state ? item.state : 'state not updated yet.'}
              </Text>
              <Text
                style={{color: '#222222', width: 150, marginHorizontal: 10}}>
                {item.zip ? item.zip : 'Zip not updated yet.'}
              </Text>
            </View>
          </View>
          <View
